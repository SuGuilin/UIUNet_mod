...
# 数据集下载地址：https://github.com/YimianDai/sirst/tree/master
class SirstDataset(Data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        img = Image.open(img_path).convert('RGB')  # 将图像转换为RGB模式
    ...
    def _sync_transform(self, img, mask):
        # random mirror
        if random.random() < 0.5:  # 以50%的概率进行随机水平翻转
